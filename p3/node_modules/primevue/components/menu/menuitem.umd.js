...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{class:_vm.containerClass,style:(_vm.item.style),attrs:{"role":"menuitem"}},[_c('a',{staticClass:"p-menuitem-link",attrs:{"href":_vm.item.url||'#',"target":_vm.item.target},on:{"click":_vm.onClick}},[_c('span',{class:['p-menuitem-icon', _vm.item.icon]}),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(_vm.item.label))])])])}
var staticRenderFns = []
