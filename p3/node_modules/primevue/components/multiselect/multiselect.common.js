...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2ec0fcfe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/multiselect/MultiSelect.vue?vue&type=template&id=1810b946&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"container",class:_vm.containerClass,on:{"click":_vm.onClick}},[_c('div',{staticClass:"p-hidden-accessible"},[_c('input',{ref:"focusInput",attrs:{"type":"text","role":"listbox","readonly":"","disabled":_vm.disabled,"tabindex":_vm.tabindex},on:{"focus":_vm.onFocus,"blur":_vm.onBlur,"keydown":_vm.onKeyDown}})]),_c('div',{staticClass:"p-multiselect-label-container"},[_c('label',{class:_vm.labelClass},[_vm._t("value",[_vm._v("\n                "+_vm._s(_vm.label)+"\n            ")],{"value":_vm.value})],2)]),_vm._m(0),_c('transition',{attrs:{"name":"p-input-overlay"},on:{"enter":_vm.onOverlayEnter,"leave":_vm.onOverlayLeave}},[(_vm.overlayVisible)?_c('div',{ref:"overlay",staticClass:"p-multiselect-panel"},[_c('div',{staticClass:"p-multiselect-header"},[_c('div',{staticClass:"p-checkbox p-component",on:{"click":_vm.onToggleAll}},[_c('div',{staticClass:"p-hidden-accessible"},[_c('input',{attrs:{"type":"checkbox","readonly":""},on:{"focus":_vm.onHeaderCheckboxFocus,"blur":_vm.onHeaderCheckboxBlur}})]),_c('div',{class:['p-checkbox-box p-component', {'p-highlight': _vm.allSelected, 'p-focus': _vm.headerCheckboxFocused}]},[_c('span',{class:['p-checkbox-icon p-c', {'pi pi-check': _vm.allSelected}]})])]),(_vm.filter)?_c('div',{staticClass:"p-multiselect-filter-container"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.filterValue),expression:"filterValue"}],staticClass:"p-multiselect-filter p-component p-inputtext p-component",attrs:{"type":"text","placeholder":_vm.filterPlaceholder},domProps:{"value":(_vm.filterValue)},on:{"input":function($event){if($event.target.composing){ return; }_vm.filterValue=$event.target.value}}}),_c('span',{staticClass:"p-multiselect-filter-icon pi pi-search"})]):_vm._e(),_c('button',{staticClass:"p-multiselect-close p-link",on:{"click":_vm.onCloseClick}},[_c('span',{staticClass:"p-multiselect-close-icon pi pi-times"})])]),_c('div',{ref:"itemsWrapper",staticClass:"p-multiselect-items-wrapper",style:({'max-height': _vm.scrollHeight})},[_c('ul',{staticClass:"p-multiselect-items p-multiselect-list p-component"},_vm._l((_vm.visibleOptions),function(option,i){return _c('li',{key:_vm.getOptionLabel(option),class:['p-multiselect-item', {'p-highlight': _vm.isSelected(option), 'p-disabled': _vm.isOptionDisabled(option)}],attrs:{"aria-label":_vm.getOptionLabel(option),"tabindex":_vm.tabindex||'0'},on:{"click":function($event){return _vm.onOptionSelect($event, option)},"keydown":function($event){return _vm.onOptionKeyDown($event, option)}}},[_c('div',{staticClass:"p-checkbox p-component"},[_c('div',{class:['p-checkbox-box p-component', {'p-highlight': _vm.isSelected(option)}]},[_c('span',{class:['p-checkbox-icon p-c', {'pi pi-check': _vm.isSelected(option)}]})])]),_vm._t("option",[_c('span',[_vm._v(_vm._s(_vm.getOptionLabel(option)))])],{"option":option,"index":i})],2)}),0)])]):_vm._e()])],1)}
...
// CONCATENATED MODULE: ./src/components/multiselect/MultiSelect.vue?vue&type=template&id=1810b946&
  ...
  methods: {
      ...
      if (this.value) {
        ...
        try {
          for (var _iterator = this.value[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (ObjectUtils_ObjectUtils.equals(val, optionValue, this.dataKey)) {
              selected = true;
              break;
            }
          }
    ...
    onOptionSelect: function onOptionSelect(event, option) {
      ...
      if (selected) value = this.value.filter(function (val) {
        return !ObjectUtils_ObjectUtils.equals(val, _this.getOptionValue(option), _this.dataKey);
      ...
      if (this.options) {
        ...
        try {
          for (var _iterator2 = this.options[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (ObjectUtils_ObjectUtils.equals(optionValue, val, this.dataKey)) {
