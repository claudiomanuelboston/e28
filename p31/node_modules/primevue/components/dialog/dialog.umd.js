...
// module
exports.push([module.i, ".p-dialog{position:fixed;padding:0;top:50%;left:50%;-webkit-transform:translateX(-50%) translateY(-50%);transform:translateX(-50%) translateY(-50%)}.p-dialog-visible{display:block}.p-dialog .p-dialog-content,.p-dialog .p-dialog-titlebar{padding:.5em .75em;position:relative;border:0}.p-dialog .p-dialog-content{background:none;zoom:1}.p-dialog-resizable .p-dialog-content{overflow:auto}.p-dialog .p-resizable-handle{width:14px;height:14px;right:3px;bottom:3px;position:absolute;font-size:.1px;display:block;cursor:se-resize}.p-draggable .p-dialog-titlebar{cursor:move}.p-dialog .p-dialog-titlebar-icons{float:right}.p-dialog .p-dialog-titlebar-icons:after{content:\"\";display:table;clear:both}.p-dialog .p-dialog-titlebar-icon{text-decoration:none;padding:.125em;cursor:pointer;display:inline-block;vertical-align:middle;border:1px solid transparent}.p-dialog .p-dialog-titlebar-icon span{display:block;margin:0}.p-dialog-footer{padding:1em;text-align:right}.p-dialog-mask{position:fixed;width:100%;height:100%}.p-confirmdialog{width:30em}.p-confirmdialog.p-dialog .p-dialog-content{padding:1em 2em}.p-confirmdialog .p-dialog-content .p-confirmdialog-icon{font-size:1.5em;vertical-align:middle;margin-right:.5em}.p-confirmdialog .p-dialog-content .p-confirmdialog-message{vertical-align:middle}.p-fluid .p-dialog-footer .p-button{width:auto}.p-rtl .p-dialog .p-dialog-titlebar-close{float:left}.p-rtl .p-dialog .p-dialog-footer{text-align:left}@media screen and (max-width:40em){.p-confirmdialog{width:90%}}.p-dialog-enter-active{-webkit-transition:all .15s cubic-bezier(0,0,.2,1);transition:all .15s cubic-bezier(0,0,.2,1)}.p-dialog-leave-active{-webkit-transition:all 75ms cubic-bezier(.4,0,.2,1);transition:all 75ms cubic-bezier(.4,0,.2,1)}.p-dialog-enter,.p-dialog-leave-to{opacity:0;-webkit-transform:translateX(-50%) translateY(-50%) scale(.7);transform:translateX(-50%) translateY(-50%) scale(.7)}.p-dialog-maximized{-webkit-transition:none;transition:none;-webkit-transform:none;transform:none;width:100vw!important;top:0;left:0}.p-dialog-maximized .p-dialog-content{-webkit-transition:height .3s;transition:height .3s}", ""]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2ec0fcfe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/dialog/Dialog.vue?vue&type=template&id=1982aa4a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"p-dialog"},on:{"enter":_vm.onEnter,"leave":_vm.onLeave}},[(_vm.visible)?_c('div',{ref:"container",class:_vm.containerClass},[(_vm.showHeader)?_c('div',{staticClass:"p-dialog-titlebar"},[_vm._t("header",[(_vm.header)?_c('span',{staticClass:"p-dialog-title"},[_vm._v(_vm._s(_vm.header))]):_vm._e()]),_c('div',{staticClass:"p-dialog-titlebar-icons"},[(_vm.closable)?_c('button',{staticClass:"p-dialog-titlebar-icon p-dialog-titlebar-close p-link",on:{"click":_vm.close}},[_c('span',{staticClass:"p-dialog-titlebar-close-icon pi pi-times"})]):_vm._e()])],2):_vm._e(),_c('div',{staticClass:"p-dialog-content",style:(_vm.contentStyle)},[_vm._t("default")],2),(_vm.footer || _vm.$slots.footer)?_c('div',{staticClass:"p-dialog-footer"},[_vm._t("footer",[_vm._v(_vm._s(_vm.footer))])],2):_vm._e()]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/dialog/Dialog.vue?vue&type=template&id=1982aa4a&
  ...
  methods: {
    ...
    enableModality: function enableModality() {
      if (!this.mask) {
        ...
        DomHandler_DomHandler.addMultipleClasses(this.mask, 'p-component-overlay p-dialog-mask p-fadein');
